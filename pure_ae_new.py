def row_normal(data, factor=1e6):
    ...
    #divide就是data中的每个值/row_sum 每个值除以该行的总值
...
def weighted_mse(y_true, y_pred):
    ''' Hack: This fn doesn't accept additional arguments.不接受额外参数
...
class Autoencoder():
    ...
    def pretrain(self):
        ...
        for i in range(len(dims) - 1):
            ...
            # Create AE and training 创建自编码器训练
            print(i)
            if i == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_datapath", default="C:\\Users\\27170\\Desktop\\GCKT\\breast_dataset\\TCGA-BLCA.htseq_counts.csv", type=str)
    parser.add_argument("--data_type", default="count", type=str)
    parser.add_argument("--outDir", default="C:\\Users\\27170\\Desktop\\GCKT\\breast_dataset", type=str)
